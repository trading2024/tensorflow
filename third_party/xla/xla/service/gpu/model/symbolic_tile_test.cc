...
class ConstraintExpressionTest : public IndexingTestBase {
 public:
  ...
  // Produces a constraint expression that is unsatisfiable.
  ConstraintExpression UnsatisfiableConstraint() {
    ...
    CHECK(!constraints.is_satisfiable());
    return constraints;
  }
};
...
TEST_F(ConstraintExpressionTest,
  ...
  ConstraintExpression unsatisfiable_constraint = UnsatisfiableConstraint();
...
TEST_F(
  ...
  // The constraint expression should still be satisfiable...
  EXPECT_TRUE(constraints.is_satisfiable());
...
TEST_F(
  ...
  ConstraintExpression constraints = UnsatisfiableConstraint();
  ConjointConstraints conjunction_1 =
      GetConjointConstraints({{"d0", Interval{0, 5}}});
...
TEST_F(
  ...
  ConstraintExpression constraints_1 = UnsatisfiableConstraint();
  ConstraintExpression constraints_2;
...
TEST_F(
  ...
  ConstraintExpression constraints_1 = UnsatisfiableConstraint();
  ConstraintExpression constraints_2 = UnsatisfiableConstraint();
