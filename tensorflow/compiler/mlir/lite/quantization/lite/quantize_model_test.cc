...
TEST_P(QuantizeConvModelTest, QuantizationSucceeds) {
  EXPECT_OK(QuantizeModelAllOperators(&model_, tensor_type_, tensor_type_,
...
TEST_P(QuantizeConvModelTest, SkipUnspecifiedLayer) {
  EXPECT_OK(QuantizeModel(&model_, TensorType_FLOAT32, TensorType_FLOAT32,
...
TEST_F(QuantizeSplitModelTest, QuantizeSplit) {
  EXPECT_OK(QuantizeModelAllOperators(&model_, TensorType_INT8, TensorType_INT8,
                                      /*allow_float=*/false, TensorType_INT8,
                                      output_buffer_));
...
TEST_P(QuantizeConvModel2Test, VerifyConvQuantization) {
  ASSERT_OK(QuantizeModelAllOperators(&model_, tensor_type_, tensor_type_,
                                      /*allow_float=*/false, tensor_type_,
                                      output_buffer_));
...
TEST_F(QuantizeSoftmaxTest, VerifySoftmaxQuantization) {
  ASSERT_OK(QuantizeModelAllOperators(&model_, TensorType_INT8, TensorType_INT8,
                                      /*allow_float=*/false, TensorType_INT8,
                                      output_buffer_));
...
TEST_F(QuantizeLSTMTest, VerifyLSTM) {
  ASSERT_OK(QuantizeModelAllOperators(
...
TEST_P(QuantizeFCTest, VerifyFCFor16x8) {
  ASSERT_OK(QuantizeModelAllOperators(&model_, TensorType_INT8, TensorType_INT8,
                                      /*allow_float=*/false, TensorType_INT16,
                                      output_buffer_));
...
TEST_P(QuantizeCustomOpTest, VerifyMixedQuantization) {
  ASSERT_OK(QuantizeModelAllOperators(&model_, GetParam(), GetParam(),
...
TEST_F(QuantizePackTest, VerifyPack) {
  ASSERT_OK(QuantizeModel(&model_, output_buffer_));
...
TEST_F(QuantizeWhereModelTest, QuantizeWhere) {
  ...
  EXPECT_OK(QuantizeModel(&model_, TensorType_BOOL, TensorType_INT64,
                          output_buffer_));
